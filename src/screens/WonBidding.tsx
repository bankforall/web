...
<BaseLayout>
    <div className='py-40 items-center text-center'>
        ...
        <div className='text-xs'>Your won bidding for Baht 2,500 </div> 
        <div className='text-xs'> with Baht 50 interest rate per month </div>
        <button
              type="submit"
              className=" py-3 px-4 mt-12 w-40 text-center bg-lightpurple text-white font-bold rounded-lg"
            >
              CLOSE
        </button>
    </div>
